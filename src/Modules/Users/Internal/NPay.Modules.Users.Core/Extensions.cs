...
public static class Extensions
{
    ...
    public static IBusRegistrationConfigurator ConfigureMasstrasnitForUsersModule(this IBusRegistrationConfigurator busconfig)
    {
        var coreAssembly = Assembly.GetExecutingAssembly();

        busconfig.AddConsumers(coreAssembly);
